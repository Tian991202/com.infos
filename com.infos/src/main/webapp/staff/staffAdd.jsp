...
<body>
<form action="/com_infos_war/AddstaffServlet" method="post">
    <table align="center" width="500">
        ...
        <div class="biaodan">
            ...
            <div class="lie2">
                ...
                <input type="text" name="staffSex" placeholder="员工性别" />
            </div>
            <div class="lie3">
                <!-- <h3 class="fontlist2">客户名称</h3> -->
                <input type="text" name="staffAge" placeholder="员工年龄" />
            </div>
            <div class="lie4">
                <!-- <h3 class="fontlist2">客户名称</h3> -->
                <input type="text" name="staffDuty" placeholder="员工职务" />
            </div>
            <div class="lie4">
                <!-- <h3 class="fontlist2">客户名称</h3> -->
                <input type="text" name="staffWage" placeholder="员工工资" />
            </div>
